...
curl -o ~/montys.omp.json https://github.com/JanDeDobbeleer/oh-my-posh/raw/main/themes/montys.omp.json

# https://ohmyposh.dev/docs/installation/prompt
# echo "eval \"\$(oh-my-posh init bash)\"" >> ~/.bashrc
# echo "eval \"\$(oh-my-posh init bash --config ~/montys.omp.json)\"" >> ~/.bashrc
echo "eval \"\$(oh-my-posh init bash --config 'https://github.com/JanDeDobbeleer/oh-my-posh/raw/main/themes/montys.omp.json')\"" >> ~/.bashrc
exec bash
. ~/.profile