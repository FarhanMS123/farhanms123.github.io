...
export default function ChatParser() {
    ...
    const [roles, setRoles] = useState<RoleFormat[]>([
        { role: "system", format: "system: {{prompt}}\n" },
        { role: "user", format: "user: {{prompt}}\n" },
        { role: "assistant", format: "assistant: {{prompt}}\n" },
    ]);
